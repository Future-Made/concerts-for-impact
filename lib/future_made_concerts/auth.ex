defmodule FutureMadeConcerts.Auth do
  @moduledoc """
  Includes functions used to perform authentication.
  """

  alias FutureMadeConcerts.Spotify.{Schema.User, Session}
  ...
  defp spotify_session, do: Application.get_env(:FutureMadeConcerts, :spotify_session)
end
