defmodule FutureMadeConcerts.Spotify.Session.HTTP do
  @moduledoc """
  ...
  The state machine implements the `FutureMadeConcerts.Spotify.Session` behaviour for its public API
  ...
  @behaviour FutureMadeConcerts.Spotify.Session

  alias FutureMadeConcerts.Spotify.{Schema, Session, SessionRegistry}
  ...
  def setup(session_id, credentials) do
    FutureMadeConcerts.Spotify.Supervisor.ensure_session(session_id, credentials)
  end

  @impl true
  def subscribe(session_id) do
    PubSub.subscribe(FutureMadeConcerts.PubSub, session_id)
    caller = self()
  ...
  def broadcast(session_id, message) do
    PubSub.broadcast(FutureMadeConcerts.PubSub, session_id, message)
  end
  ...
  defp spotify_client, do: Application.get_env(:FutureMadeConcerts, :spotify_client)
end
