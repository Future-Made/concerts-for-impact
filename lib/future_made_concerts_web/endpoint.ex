defmodule FutureMadeConcertsWeb.Endpoint do
  @moduledoc false
  use Sentry.PlugCapture
  use Phoenix.Endpoint, otp_app: :FutureMadeConcerts
  ...
  socket "/socket", FutureMadeConcertsWeb.UserSocket,
    websocket: true,
    longpoll: false
  ...
  plug FutureMadeConcertsWeb.Router

  def init(_type, config) do
    %{web: runtime_overrides} = Vapor.load!(FutureMadeConcerts.Config)
