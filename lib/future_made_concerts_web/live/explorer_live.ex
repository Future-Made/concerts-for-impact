defmodule FutureMadeConcertsWeb.ExplorerLive do
  @moduledoc """
  ...
  When mounting, `FutureMadeConcertsWeb.ExplorerLive` uses the session data to start a
  ...
  use FutureMadeConcertsWeb, :live_view

  alias FutureMadeConcerts.Spotify.Schema.{Album, Device, Player, Track, User}

  alias FutureMadeConcertsWeb.{
    AlbumView,
    ArtistView,
    MiniPlayerComponent,
  ...
  defp generate_device_name do
    "FutureMadeConcerts-" <> Device.generate_name()
  end
end
