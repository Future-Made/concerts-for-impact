defmodule FutureMadeConcertsWeb.LoggedInTest do
  use FutureMadeConcertsWeb.ConnCase
  use ExUnitProperties

  alias FutureMadeConcerts.Duration
  alias FutureMadeConcerts.Generators
  alias FutureMadeConcerts.Spotify.Schema.{Album, Artist, Episode, Player, Show, Track}
  ...
  describe "mini player" do
    ...
    property "it supports control operations", %{conn: conn} do
      check all(
        ...
        FutureMadeConcerts.Spotify.Session.Mock
  ...
  describe "search" do
    ...
    property "it supports searching for other types", %{conn: conn} do
      check all(
        ...
        item_name = FutureMadeConcertsWeb.SearchView.name(item)
